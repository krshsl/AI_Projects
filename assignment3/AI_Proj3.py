...
class PARENT_BOT:
    ...
    def start_rescue(self):
        ...
        if self.ship.get_state(self.local_crew_pos) & TELEPORT_CELL:
            self.csv_data.append([self.local_bot_pos, self.local_crew_pos, self.ship.closed_cells,self.ship.walls])
...
def create_file(file_name):
    column_headings = ["Bot_Cell", "Crew_Cell", "Closed_Cells","Walls"]
